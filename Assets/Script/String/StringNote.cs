...
public class StringNote : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        str = " Abc Def Fed Cba ";  //앞뒤에 공백 하나씩주어서 값 저장
        ...
        //공백 제거
        Debug.Log(str.Trim());  //앞뒤 양쪽 공백 제어
        ...
        Debug.Log(str.Remove(5,3));    //5번 인덱스부터 3글자 삭제 가져오기

        //비교
        Debug.Log(str[1] == str[15]);   //false
        Debug.Log("ABC".Equals("Abc"));     //false
        Debug.Log(System.String.Compare("BAC","Bac"));  //0(같음), 1, -1
